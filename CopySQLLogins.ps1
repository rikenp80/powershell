   cls
    ...
    $PrimaryServer_SQL = New-Object Microsoft.SqlServer.Management.Smo.Server ("reportdb110")
    $SecondaryServer_SQL = New-Object Microsoft.SqlServer.Management.Smo.Server ("reportdb111")
    ...
    {
        if ($login.Name -ne "sa" -and $login.Name -notlike "##*" -and $login.IsDisabled -eq $false -and $LoginType -eq "SqlLogin")
        {
